<template>
  <div class="StatsHeatmap">
    <div class="StatsHeatmap-header">
      ...
      <div class="StatsHeatmap-subtitle">Find your most productive hours</div>
    </div>
    ...
    <div v-if="heatmapData" class="Heatmap">
          ...
          >
            ...
            <div class="Heatmap-cells">
              <div
                ...
                :title="`${getDayLabel(dayIndex)} ${hourIndex}:00 - ${count} sessions`"
              >
              </div>
            </div>
          </div>
      ...
      <div v-if="insights" class="Heatmap-insights">
        <div class="Insight">
          ...
          <span class="Insight-text">Best Hour: {{ insights.peakHour }}</span>
        </div>
        <div class="Insight">
          <span class="Insight-icon">📅</span>
          <span class="Insight-text">Best Day: {{ insights.peakDay }}</span>
        </div>
      </div>
    </div>
