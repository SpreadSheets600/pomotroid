<template>
  <div class="StatsInterruptions">
    <div class="StatsInterruptions-header">
      ...
      <div class="StatsInterruptions-subtitle">Identify your biggest distractions</div>
    </div>
    ...
    <div v-if="stats && stats.length > 0" class="InterruptionChart">
      ...
      >
        ...
        <div class="InterruptionChart-content">
          ...
          <div class="InterruptionChart-bar-wrapper">
            ...
            >
              <span class="InterruptionChart-count">{{ item.count }} times</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="InterruptionChart-tip">
        ...
        <span>Use these patterns to reduce interruptions and improve focus.</span>
      </div>
    </div>

    <div v-else-if="stats && stats.length === 0" class="StatsInterruptions-empty">
      <div class="StatsInterruptions-empty-icon">✅</div>
      <p>Great work. No interruptions recently.</p>
      <p class="StatsInterruptions-empty-hint">Keep the momentum.</p>
    </div>
