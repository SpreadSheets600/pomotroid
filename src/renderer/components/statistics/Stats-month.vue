  ...
  <div class="StatsMonthView">
    <div v-if="stats" class="StatsMonthView-content">
      <div class="StatsMonthView-header">
        <h2 class="StatsMonthView-title">This Month</h2>
